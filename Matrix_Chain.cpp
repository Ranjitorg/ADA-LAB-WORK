...
void UE243116_print_Parenthesis(int i, int j, vector<vector<int>>& S) {
 ...
 cout << "(";
 UE243116_print_Parenthesis(i, S[i][j], S);
 UE243116_print_Parenthesis(S[i][j] + 1, j, S);
 cout << ")";
}
int main() {
 ...
 UE243116_print_Parenthesis(1, 5, S);
 return 0;
}
